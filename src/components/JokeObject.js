    ...
    view(vnode) {
        ...
        return (
            <div class={"card shadow mb-3 p-3 bg-white rounded"}>
                ...
                <button 
                    class={vnode.attrs.disliked ? "btn-danger m-1 float-right" : "btn-outline-danger m-1 float-right"}
                ...
                <span class="badge badge-secondary">{vnode.attrs.dislikes}</span>
                </button>
                <button 
                    class={vnode.attrs.liked ? "btn-success m-1 float-right" : "btn-outline-success m-1 float-right"}
                ...
                >
                    ...
                    <span class="badge badge-secondary">{vnode.attrs.likes}</span>
                </button>
                </div>
            </div>
        )
